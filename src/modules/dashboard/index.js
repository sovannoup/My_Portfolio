...
export function* AddMenuAdminWorker({ payload }) {
  try {
    const add_menu_admin = yield call(
      axios.post,
      "/menu-admin/insert",
      payload
    );
...
export function* updateMenuAdminWorker({ payload }) {
  try {
    const update_menu_admin = yield call(
      axios.post,
      "/menu-admin/update",
      payload
    );
...
export function* deleteMenuAdminWorker({ payload }) {
  try {
    const delete_menu_admin = yield call(
      axios.post,
      "/menu-admin/delete",
      payload
    );
...
export function* getUserPermissionWorker({ payload }) {
  ...
  try {
    const user_permission = yield call(
      axios.get,
      "/user-permission/view/" + payload
    );
...
export function* updatePermissionWorker({ payload }) {
  try {
    const update_permission = yield call(
      axios.post,
...
export function* updateSiteDescriptionWorker({ payload }) {
  try {
    ...
    const dataUpdateSiteDescription = yield call(
      axios.post,
...
export function* addSiteDescriptionWorker({ payload }) {
  try {
    const dataAddSiteDescription = yield call(
      axios.post,
